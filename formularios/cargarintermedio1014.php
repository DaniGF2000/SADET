...
error_reporting( ~E_NOTICE ); // avoid notice
 ...
 if(isset($_POST['guardar']))
 {
  ...
  {
   $upload_dir = 'educandos/intermedio10-14/'; // upload directory
   ...
   if(in_array($imgExt && $imgExt1 && $imgExt2 && $imgExt3 && $imgExt4 && $imgExt5, $valid_extensions)){   
    ...
    $errMSG = header("location:intermedio10-14.php");
   }
  }
   ...
   $stmt = $DB_con->prepare('INSERT INTO intermedio10_14(acta,curp,foto,boleta,reganv,regrev,idusuario) VALUES(:upic, :upic1, :upic2, :upic3, :upic4, :upic5, :uname)');
   ...
   {
    $errMSG = header("location:intermedio.php");
   }
 }
}
?>