...
error_reporting( ~E_NOTICE ); // avoid notice
 ...
 if(isset($_POST['guardar']))
 {
  ...
  {
   $upload_dir = 'educandos/inicial/'; // upload directory
   ...
   $stmt = $DB_con->prepare('INSERT INTO inicial(acta,curp,foto,boleta,reganv,regrev,idusuario) VALUES(:upic, :upic1, :upic2, :upic3, :upic4, :upic5, :uname)');
